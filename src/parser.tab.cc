...
#line 139 "parser.y"
                {std::cout << "suite := statement" << std::endl;}
#line 3404 "parser.tab.cc"
    break;

  case 17: // suite: statement suite
#line 140 "parser.y"
                      {std::cout << "suite := statement suite" << std::endl;}
...
#line 148 "parser.y"
                                     {std::cout << "statement := single_statement ;" << std::endl;}
...
#line 153 "parser.y"
                                        {std::cout << "single_statement := declaration = expression" << std::endl;}
#line 3434 "parser.tab.cc"
    break;

  case 22: // single_statement: name TOK_ASSIGN expression
#line 154 "parser.y"
                                 {std::cout << "single_statement := name = expression" << std::endl;}
#line 3440 "parser.tab.cc"
    break;

  case 23: // single_statement: name augmented_assign expression
#line 155 "parser.y"
                                       {std::cout << "single_statement := name binary_op = expression" << std::endl;}
#line 3446 "parser.tab.cc"
    break;

  case 24: // single_statement: TOK_BREAK
#line 156 "parser.y"
                {std::cout << "single_statement := break" << std::endl;}
#line 3452 "parser.tab.cc"
    break;

  case 25: // single_statement: TOK_CONTINUE
#line 157 "parser.y"
                   {std::cout << "single_statement := continue" << std::endl;}
#line 3458 "parser.tab.cc"
    break;

  case 26: // single_statement: TOK_RETURN
#line 158 "parser.y"
                 {std::cout << "single_statement := return" << std::endl;}
#line 3464 "parser.tab.cc"
    break;

  case 27: // single_statement: TOK_RETURN expression
#line 159 "parser.y"
                            {std::cout << "single_statement := return expression" << std::endl;}
#line 3470 "parser.tab.cc"
    break;

  case 28: // single_statement: expression
#line 160 "parser.y"
                 {std::cout << "single_statement := expression" << std::endl;}
#line 3476 "parser.tab.cc"
    break;

  case 29: // augmented_assign: TOK_PLUS_ASSIGN
#line 164 "parser.y"
                      {std::cout << "augmented_assign := +=" << std::endl;}
#line 3482 "parser.tab.cc"
    break;
...
#line 166 "parser.y"
                      {std::cout << "augmented_assign := *=" << std::endl;}
#line 3494 "parser.tab.cc"
    break;

  case 32: // augmented_assign: TOK_SLASH_ASSIGN
#line 167 "parser.y"
                       {std::cout << "augmented_assign := /=" << std::endl;}
#line 3500 "parser.tab.cc"
    break;

  case 33: // expression: ternary_expression
#line 171 "parser.y"
                         {std::cout << "expression := ternary_expression" << std::endl;}
#line 3506 "parser.tab.cc"
    break;

  case 34: // ternary_expression: logical_expression
#line 175 "parser.y"
                         {std::cout << "ternary_expression := logical_expression" << std::endl;}
#line 3512 "parser.tab.cc"
    break;

  case 35: // ternary_expression: logical_expression TOK_QUESTION_MARK logical_expression TOK_COLON ternary_expression
#line 177 "parser.y"
        {std::cout << "ternary_expression := logical_expression ? logical_expression : ternary_expression" << std::endl;}
#line 3518 "parser.tab.cc"
    break;

  case 36: // logical_expression: equality
#line 181 "parser.y"
               {std::cout << "logical_expression := equality" << std::endl;}
#line 3524 "parser.tab.cc"
    break;

  case 37: // logical_expression: equality TOK_LOG_AND logical_expression
#line 182 "parser.y"
                                              {std::cout << "logical_expression := equality && logical_expression" << std::endl;}
#line 3530 "parser.tab.cc"
    break;

  case 38: // logical_expression: equality TOK_LOG_OR logical_expression
#line 183 "parser.y"
                                             {std::cout << "logical_expression := equality || logical_expression" << std::endl;}
#line 3536 "parser.tab.cc"
    break;

  case 39: // equality: comparison
#line 187 "parser.y"
                 {std::cout << "equality := comparison" << std::endl;}
#line 3542 "parser.tab.cc"
    break;

  case 40: // equality: comparison TOK_EQ equality
#line 188 "parser.y"
                                 {std::cout << "equality := comparison == equality" << std::endl;}
#line 3548 "parser.tab.cc"
    break;

  case 41: // equality: comparison TOK_NE equality
#line 189 "parser.y"
                                 {std::cout << "equality := comparison != equality" << std::endl;}
#line 3554 "parser.tab.cc"
    break;

  case 42: // comparison: term
#line 193 "parser.y"
           {std::cout << "comparison := term" << std::endl;}
#line 3560 "parser.tab.cc"
    break;

  case 43: // comparison: term TOK_LT comparison
#line 194 "parser.y"
                             {std::cout << "comparison := term < comparison" << std::endl;}
#line 3566 "parser.tab.cc"
    break;

  case 44: // comparison: term TOK_LE comparison
#line 195 "parser.y"
                             {std::cout << "comparison := term <= comparison" << std::endl;}
#line 3572 "parser.tab.cc"
    break;

  case 45: // comparison: term TOK_GT comparison
#line 196 "parser.y"
                             {std::cout << "comparison := term > comparison" << std::endl;}
#line 3578 "parser.tab.cc"
    break;

  case 46: // comparison: term TOK_GE comparison
#line 197 "parser.y"
                             {std::cout << "comparison := term >= comparison" << std::endl;}
#line 3584 "parser.tab.cc"
    break;

  case 47: // term: factor
#line 201 "parser.y"
             {std::cout << "term := factor" << std::endl;}
#line 3590 "parser.tab.cc"
    break;
...
#line 203 "parser.y"
                            {std::cout << "term := factor - term" << std::endl;}
#line 3602 "parser.tab.cc"
    break;

  case 50: // factor: unary_expression
#line 207 "parser.y"
                       {std::cout << "factor := unary_expression" << std::endl;}
#line 3608 "parser.tab.cc"
    break;

  case 51: // factor: unary_expression TOK_STAR factor
#line 208 "parser.y"
                                       {std::cout << "factor := unary_expression * factor" << std::endl;}
#line 3614 "parser.tab.cc"
    break;
...
#line 3762 "parser.tab.cc"
  ...
  parser::yyrline_[] =
  {
     ...
     121,   125,   129,   130,   134,   135,   139,   140,   144,   148,
     149,   153,   154,   155,   156,   157,   158,   159,   160,   164,
     165,   166,   167,   171,   175,   176,   181,   182,   183,   187,
     188,   189,   193,   194,   195,   196,   197,   201,   202,   203,
     207,   208,   209,   213,   214,   215,   219,   220,   221,   222,
     223,   224,   225,   229,   230,   231,   235,   236,   240,   241,
     245,   246,   250,   251,   255,   256
  };
